module.exports = class Data1665589384755 {
  ...
  async down(db) {
    ...
    await db.query(`DROP INDEX "public"."IDX_8e3b2048c68bc97bc348f2594d"`)
    await db.query(`DROP TABLE "back_to_the_future_score"`)
    await db.query(`DROP INDEX "public"."IDX_6c8d9f3add711d446ec05ec1a4"`)
    await db.query(`DROP TABLE "the_pressiah_cometh_score"`)
    await db.query(`DROP INDEX "public"."IDX_ff2467003a8e029ed56cebba27"`)
