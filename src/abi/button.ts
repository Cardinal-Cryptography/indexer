...
export const metadata = {
  ...
  spec: {
    ...
    events: [
      {
        ...
        docs: [' Event emitted when TheButton is pressed'],
        label: 'ButtonPressed',
      },
      {
        args: [
    ...
    messages: [
      ...
      {
        args: [],
        docs: [' Returns the curent round number'],
        label: 'round',
        mutates: false,
        payable: false,
        returnType: {
      ...
      {
        args: [],
        docs: [' Returns the buttons status'],
        label: 'is_dead',
        mutates: false,
        payable: false,
        returnType: {
      ...
      {
        args: [],
        docs: [' Returns the current access control contract address'],
      ...
      {
        args: [],
        docs: [" Returns address of the game's reward token"],
        label: 'reward_token',
        mutates: false,
        payable: false,
        returnType: {
      ...
      {
        args: [],
        docs: [" Returns address of the game's ticket token"],
        label: 'ticket_token',
        mutates: false,
        payable: false,
        returnType: {
  ...
  types: [
    ...
    },
    {
      ...
      type: {
        ...
        path: ['button', 'button_game', 'Scoring'],
      },
    },
    {
      id: 8,
    ...
    },
    {
      ...
      type: {
        ...
        path: ['shared_traits', 'haltable', 'HaltableError'],
      },
    },
    {
      id: 22,
    ...
    },
    {
      ...
      type: {
        ...
        path: ['access_control', 'roles', 'Role'],
      },
    },
    {
      id: 24,
    ...
    },
    {
      ...
      type: {
        ...
        path: ['marketplace', 'marketplace', 'Error'],
      },
    },
    {
      id: 28,
...
export type Message =
  ...
  | Message_round
  | Message_is_dead
  | Message_last_presser
  | Message_access_control
  | Message_reward_token
  | Message_ticket_token
  | Message_marketplace
  | Message_code_hash
  | Message_press
  | Message_reset
  | Message_reward_pressiah
  | Message_set_access_control
  | Message_set_button_lifetime
  | Message_set_min_reward
  | Message_set_max_reward
  | Message_terminate
  | Message_set_code;
...
export type GameError =
  | GameError_HaltableError
  | GameError_BeforeDeadline
  | GameError_AfterDeadline
  | GameError_MissingRole
  | GameError_PSP22Error
  | GameError_InkEnvError
  | GameError_CantRetrieveOwnCodeHash
  | GameError_Arithmethic
  | GameError_MarketplaceError
  | GameError_ContractCall;
...
export type Scoring =
  | Scoring_EarlyBirdSpecial
  | Scoring_BackToTheFuture
  | Scoring_ThePressiahCometh;
...
export type HaltableError =
  | HaltableError_InHaltedState
  | HaltableError_NotInHaltedState
  | HaltableError_Custom;
...
export type PSP22Error =
  | PSP22Error_Custom
  | PSP22Error_InsufficientBalance
  | PSP22Error_InsufficientAllowance
  | PSP22Error_ZeroRecipientAddress
  | PSP22Error_ZeroSenderAddress
  | PSP22Error_SafeTransferCheckFailed;
...
export type Error =
  ...
  | Error_MissingRole
  | Error_ContractCall
  | Error_PSP22TokenCall
  | Error_MaxPriceExceeded
  | Error_MarketplaceEmpty;
